# Guia de README i nota tècnica de decisió
...
En el mòdul, el `README` i les notes tècniques de decisió no són complements decoratius. Formen part de les evidències autèntiques del treball: permeten entendre què s'ha construït, com s'executa, quines decisions s'han pres i com es podria continuar o mantindre el projecte.
...
Una nota tècnica de decisió s'ha d'usar quan cal documentar una decisió tècnica rellevant, per exemple:
...
Contingut mínim d'una nota tècnica de decisió:
...
- no fa falta una nota tècnica per cada detall menor
...
- crear notes tècniques massa genèriques, massa tard o per decisions irrellevants
...
- les notes tècniques documenten decisions significatives, no detalls trivials
