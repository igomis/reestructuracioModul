...
- quin és el mínim funcional exigible: registre o alta, login, logout i una operació protegida
...
- una comprovació d'accés a una ruta o operació protegida
...
- login correcte
- login incorrecte
- accés autoritzat a una operació protegida
...
- [ ] existix almenys una operació del domini protegida
