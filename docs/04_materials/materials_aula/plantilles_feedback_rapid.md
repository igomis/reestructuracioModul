...
El següent pas clar és:
- ara et toca:

No ho dones per tancat fins que:
- pugues ensenyar:
```
...
El problema principal és:
- ara mateix no es pot verificar:

Abans de seguir has de:
- tancar:
```
...
Per convertir-ho en evidència vàlida, necessite veure:
- prova:
- registre:
- actualització de:
```
...
Perquè compte com a repte superat, has de convertir-ho en:
- flux real:
- verificació:
- defensa:
```
...
No amplifiques obrint un camí nou; amplia millorant:
- el mateix flux principal
```
...
- `No òbrigues més abast fins que el que tens siga defensable.`
- `Ja pots ampliar, però sense separar-te del producte base del curs.`
