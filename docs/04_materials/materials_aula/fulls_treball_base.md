...
Ajuda si et bloqueges
- Torna a l'apunt real de:
- Revisa el material comú de:
- Demana checkpoint curt si continues bloquejat:
...
- Validació mínima: prova un cas correcte i un cas denegat
- Ajuda si et bloqueges: torna a l'apunt real de `R2` i revisa el flux mínim
...
- Validació mínima: una prova manual o automatitzada del flux principal
- Ajuda si et bloqueges: revisa contracte, codis d'estat i documentació mínima
- Ampliació si acabes prompte: reforça proves o qualitat de documentació del mateix endpoint
