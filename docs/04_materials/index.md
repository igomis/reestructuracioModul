...
- [Guia Git i flux de treball](materials_comuns/guia_git_i_flux_treball.md): base comun metodologica.
- [Guia README i ADR](materials_comuns/guia_readme_i_adr.md): traçabilitat i decisions.
