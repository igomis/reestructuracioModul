...
| Defensa tècnica i autoria | 15% | Explica amb precisió què ha fet, per què funciona el flux complet, què ha fallat i com ho ha corregit. | Defensa el treball amb seguretat general i dubtes puntuals no crítics. | La defensa és parcial, superficial o insegura en parts rellevants. | No pot defensar el treball ni demostrar autoria efectiva. | Defensa oral o escrita, preguntes de contrast, microcanvis en directe, coherència amb el repositori. |
