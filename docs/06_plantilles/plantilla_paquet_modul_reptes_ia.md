...
- Càrrega horària orientativa:
- Distribució temporal real:
...
| **Arquitectura o consolidació** | | | |
| **Publicació o lliurament extern** | | | |
| **Tancament i defensa** | | | |
...
- Acta de checkpoint:
- Rúbrica base de seguiment:
- Rúbrica de defensa o tancament:
...
- Grau de flexibilitat del projecte base:
- Intensitat de seguiment docent possible:
- Adaptació a altres stacks, contextos o dominis:
...
- existixen evidències i instruments de seguiment
- la implantació temporal és executable
- la IA està tractada com a eina guiada i verificable
- el paquet és reutilitzable i contextualitzable
