...
- almenys un cas d’ús real del producte refactoritzat, persistent i verificable de punta a punta
...
- demostrar que la funcionalitat clau del producte continua viva després de la refactorització, no només més “ordenada”
...
- moure fitxers, crear capes buides o afegir ORM sense consolidar un cas d’ús real no es considera suficient
...
- almenys un cas d’ús prioritari complet migrat a l’estructura nova i connectat amb persistència real
...
3. **Migració de capes i casos d’ús**
   - separar controladors, serveis/casos d’ús i capa de dades sobre una funcionalitat real del producte.
...
- migrar un primer cas d’ús complet del domini com a patró
...
- demostració d’un cas d’ús real del domini abans i després de la refactorització
...
- demostració de fluxos crítics abans/després de la refactorització sobre un cas d’ús real del producte
...
- existeix almenys un cas d’ús real del producte refactoritzat, persistent i verificat de punta a punta
...
- una reorganització purament cosmètica o una persistència només aparent no es consideren suficients
