...
- [Fitxa general del Repte 1](../02_reptes/repte_01_kickoff_backend.md)
...
- [Materials de sessió del Repte 1](../04_materials/materials_aula/repte_01_materials_sessio.md)
...
- [Plantilles de feedback ràpid](../04_materials/materials_aula/plantilles_feedback_rapid.md)
- [Guió breu de defensa individual](../08_materials_compartibles/guio_defensa_individual_breu.md)
- [Guia testing i debugging](../04_materials/materials_comuns/guia_testing_i_debugging.md)

## Resultat mínim que ha de quedar preparat
...
Si només necessites obrir el curs, encara et servirà el [paquet d'inici de curs](paquet_inici_curs.md). Si el que vols és conduir `R1` de punta a punta amb seqüència, materials i tancament, este és el paquet directe que convé tindre a mà.
