# Paquet d'inici de curs

## Finalitat del paquet
Obrir el curs amb un missatge clar, deixar orientat el projecte base i activar `R1` sense dispersió.
...
- [Full de treball del Repte 1](../08_materials_compartibles/full_treball_repte_01.md)
- [Guió breu d'ús de la IA per a l'alumnat](../08_materials_compartibles/guio_ús_ia_per_a_lalumnat.md)
- [Projectes base](../alumnat/projectes_base.md)

## Què es projecta
- el [Briefing inicial del curs](../08_materials_compartibles/briefing_inicial_curs.md)
- el bloc central del [Full de treball del Repte 1](../08_materials_compartibles/full_treball_repte_01.md)
