...
- que Express, si apareix, només ha de funcionar com a suport lleuger i no com a nou focus d'aprenentatge
...
- usar un llenguatge real base obliga a veure el flux amb més claredat i ajuda a consolidar els `RA` previs
...
- pot usar Express només si li servix per entendre millor la recepció i resposta, sense desplaçar el focus del flux
...
- entrar en Laravel o en un framework complet i no saber explicar què passa amb la dada
