...
- [R2S2. Processament, reintent i confirmació](programacio_aula_r2s2_processament_reintent_conservacio_dades.md): fitxa d'aula executable per a la segona sessió de `R2`, associada al microrepte `R2M2`.
...
- [R2SX. Microdefensa conjunta R1 + R2](programacio_aula_r2sx_microdefenses_tecniques_criteris.md): verificació d'autoria, comprensió, base tècnica de `R1`, flux funcional de `R2` i ús d'IA.
...
- [R3S2B. Taller de portabilitat entre frameworks](programacio_aula_r3s2b_taller_portabilitat_frameworks.md): sessió obligatòria del taller `MT16` entre `R3S2` i `R3S3`, sense microrepte propi.
...
- [R3S6. Qualitat i estabilització](programacio_aula_r3s6_qualitat_estabilitzacio.md): fitxa d'aula executable per a proves, errors i estabilització de `R3`, associada al microrepte `R3M6`.
- [R3S7. Tancament tècnic](programacio_aula_r3s7_tancament_tecnic.md): fitxa d'aula executable per al tancament de `R3`, associada al microrepte `R3M7`.
...
- [R4S0. Transició al Repte 4](programacio_aula_r4s0_transicio_repte_4.md): sessió sense microrepte propi per passar d'aplicació persistent a servei web consumible.
...
- per preparar les transicions entre reptes: [R1S0](programacio_aula_r1s0_marc_comu_curs_evidencies.md), [R2S0](programacio_aula_r2s0_transicio_repte_2.md), [R3S0](programacio_aula_r3s0_transicio_repte_3.md), [R4S0](programacio_aula_r4s0_transicio_repte_4.md) i [R5S0](programacio_aula_r5s0_transicio_repte_5.md)
...
- per impartir la segona sessió de `R2`: [R2S2. Processament, reintent i confirmació](programacio_aula_r2s2_processament_reintent_conservacio_dades.md)
