...
- [R2S2. Processament i guardat funcional](programacio_aula_r2s2_processament_guardat_funcional.md): fitxa d'aula executable per a la segona sessió de `R2`, associada al microrepte `R2M2`.
...
- per impartir la segona sessió de `R2`: [R2S2. Processament i guardat funcional](programacio_aula_r2s2_processament_guardat_funcional.md)
