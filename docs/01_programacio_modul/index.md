...
- [Calendaritzacio per avaluacions](calendaritzacio_per_avaluacions.md): lectura del curs en dos avaluacions reals.
...
- [R1S3. Domini, ADR i decisió tècnica inicial](programacio_aula_r1s3_domini_adr_decisio_tecnica.md): sessió sense microrepte propi per acotar producte i decisió tècnica.
- [R1S4. Git, README i AI log operatiu](programacio_aula_r1s4_git_readme_ai_log.md): sessió sense microrepte propi per assegurar traçabilitat.
- [R1S5. Taller d'entorn reproduïble](programacio_aula_r1s5_taller_entorn_reproduible.md): sessió sense microrepte propi per estabilitzar arrencada.
- [R1S6. Primer flux backend guiat](programacio_aula_r1s6_primer_flux_backend_guiat.md): sessió sense microrepte propi per reforçar petició-resposta.
- [R1S7. Checkpoint de pas a R2](programacio_aula_r1s7_checkpoint_pas_r2.md): sessió sense microrepte propi de tancament i pas a `R2`.
...
- [R3S7. Recuperació i estabilització del projecte en framework](programacio_aula_r3s7_recuperacio_estabilitzacio_framework.md): sessió sense microrepte propi per consolidar `R3` abans de `R4`.
...
- [R4S1. Disseny del contracte del servei](programacio_aula_r4s1_contracte_servei_api.md): fitxa d'aula executable per a definir recurs, endpoints, request/response i errors, associada al microrepte `R4M1`.
- [R4S2. Implementació del primer endpoint funcional](programacio_aula_r4s2_primer_endpoint_funcional.md): fitxa d'aula executable per a publicar el primer endpoint real, associada al microrepte `R4M2`.
...
- [R4S6. Taller de coherència contracte-consum](programacio_aula_r4s6_taller_contracte_consum.md): sessió sense microrepte propi per ajustar contracte, consum i errors.
- [R4S7. Preparació del pas a R5](programacio_aula_r4s7_preparacio_pas_r5.md): sessió sense microrepte propi per preparar integració híbrida.
...
- [R5S2. Connexió amb la font externa i recuperació real](programacio_aula_r5s2_connexio_font_externa.md): fitxa d'aula executable per a implementar el connector i verificar resposta real i error, associada al microrepte `R5M2`.
...
- [R5S6. Estabilització final del flux híbrid](programacio_aula_r5s6_estabilitzacio_final_flux_hibrid.md): sessió sense microrepte propi per tancar incidències abans de defensa.
- [R5S7. Defensa final del producte](programacio_aula_r5s7_defensa_final_producte.md): sessió sense microrepte propi per defensar el producte complet.
...
- [Kit de pilotatge de les setmanes 1-4](kit_pilotatge_setmanes_01_04.md)
- [Kit de pilotatge de les setmanes 5-8](kit_pilotatge_setmanes_05_08.md)
- [Kit de pilotatge de les setmanes 9-12](kit_pilotatge_setmanes_09_12.md)
- [Kit de pilotatge de les setmanes 13-16](kit_pilotatge_setmanes_13_16.md)
- [Kit de pilotatge de les setmanes 17-20](kit_pilotatge_setmanes_17_20.md)
- [Revisio transversal del bloc pilotable de 20 setmanes](revisio_transversal_bloc_pilotable_20_setmanes.md)
- [Preparacio docent directa per al curs que ve](preparacio_docent_directa_curs_que_ve.md)
- [Ajustos finals abans de l'inici de curs](ajustos_finals_abans_inici_curs.md)

## Si has d'entrar rapid
...
- per completar les 8 sessions inicials de `R1` i arrancada: [R1S0](programacio_aula_r1s0_marc_comu_curs_evidencies.md), [R1S3](programacio_aula_r1s3_domini_adr_decisio_tecnica.md), [R1S4](programacio_aula_r1s4_git_readme_ai_log.md), [R1S5](programacio_aula_r1s5_taller_entorn_reproduible.md), [R1S6](programacio_aula_r1s6_primer_flux_backend_guiat.md) i [R1S7](programacio_aula_r1s7_checkpoint_pas_r2.md)
...
- per impartir `R4`: [R4S1](programacio_aula_r4s1_contracte_servei_api.md), [R4S2](programacio_aula_r4s2_primer_endpoint_funcional.md), [R4S3](programacio_aula_r4s3_proteccio_api.md), [R4S4](programacio_aula_r4s4_consum_servei.md), [R4S5](programacio_aula_r4s5_documentacio_prova_servei.md), [R4S6](programacio_aula_r4s6_taller_contracte_consum.md) i [R4S7](programacio_aula_r4s7_preparacio_pas_r5.md)
- per impartir `R5`: [R5S1](programacio_aula_r5s1_font_externa_i_disseny_integracio.md), [R5S2](programacio_aula_r5s2_connexio_font_externa.md), [R5S3](programacio_aula_r5s3_mapping_transformacio_valor.md), [R5S4](programacio_aula_r5s4_funcionalitat_hibrida_producte.md), [R5S5](programacio_aula_r5s5_prova_documentacio_defensa_integracio.md), [R5S6](programacio_aula_r5s6_estabilitzacio_final_flux_hibrid.md) i [R5S7](programacio_aula_r5s7_defensa_final_producte.md)
