...
| **Fase 1. Kickoff tècnic** | `3-4` | Repte 1 en `4` sessions de `3h`: base executable i landing inicial servida pel backend | fitxa del Repte 1, materials comuns, projecte base, model d'itineraris com a marc | entorn funcional, ADR inicial, `README` executable, landing inicial i primers commits útils | `rubrica_base_reptes.md` | evitar que el kickoff quede en infraestructura buida sense decisió tècnica ni producte recognoscible |
...
| **Setmanes 3-4** | entorn funcional, domini triat, ADR inicial, `README` executable i landing inicial servida pel backend |
