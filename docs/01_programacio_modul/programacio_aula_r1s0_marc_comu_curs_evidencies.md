...
Explicar el fil `R1 -> R5`, el projecte base, les evidències i la diferència entre treball cooperatiu i evidència individual.
...
L'alumnat concreta domini inicial, necessitat funcional i primeres idees de producte.

### 2:40-3:00. Checkpoint inicial

Comprovar que cada alumne o equip sap què ha de preparar per a `R1S1`.

## Evidències mínimes

| Evidència | Mínim acceptable |
|---|---|
| Repositori | creat o identificat |
| README inicial | explica producte, curs i primeres decisions |
| AI log | plantilla preparada |
| Domini | idea inicial acotada |
